...
Usage:
    python seed.py                      # seed default dev user
    python seed.py --email user@x.com   # seed custom user
    python seed.py --list               # list seeded users
...
from auth import DEFAULT_DEV_API_KEY, hash_api_key, seed_default_user
